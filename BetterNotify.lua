...
function NotificationLibrary:ShowNotification(message, soundUrl, imageUrl, customDuration, callback)
    ...
    if callback then
        callback() -- Execute the callback function after fading out
    end
end
